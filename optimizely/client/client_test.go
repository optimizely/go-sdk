...
func TestGetFeatureVariableBooleanWithValidValue(t *testing.T) {
	...
	result, _ := client.GetFeatureVariableBoolean(testFeatureKey, testFeatureFlagKey, testUserContext)
...
func TestGetFeatureVariableBooleanWithInValidValue(t *testing.T) {
	...
	result, err := client.GetFeatureVariableBoolean(testFeatureKey, testFeatureFlagKey, testUserContext)
...
func TestGetFeatureVariableDoubleWithValidValue(t *testing.T) {
	...
	result, _ := client.GetFeatureVariableDouble(testFeatureKey, testFeatureFlagKey, testUserContext)
...
func TestGetFeatureVariableDoubleWithInvalidValue(t *testing.T) {
	...
	result, err := client.GetFeatureVariableDouble(testFeatureKey, testFeatureFlagKey, testUserContext)
...
func TestGetFeatureVariableIntegerWithValidValue(t *testing.T) {
	...
	result, _ := client.GetFeatureVariableInteger(testFeatureKey, testFeatureFlagKey, testUserContext)
...
func TestGetFeatureVariableIntegerWithInvalidValue(t *testing.T) {
	...
	result, err := client.GetFeatureVariableInteger(testFeatureKey, testFeatureFlagKey, testUserContext)
...
func TestGetFeatureVariableErrorCases(t *testing.T) {
	...
	_, err := client.GetFeatureVariableBoolean("test_feature_key", "test_variable_key", testUserContext)
	assert.Error(t, err)
	_, err1 := client.GetFeatureVariableDouble("test_feature_key", "test_variable_key", testUserContext)
	assert.Error(t, err1)
