...
- Add holdout exclude_targeted_deliveries support ([#458](https://github.com/optimizely/go-sdk/pull/458))

## [2.5.0] - July 14, 2026

## What's Changed
* [FSSDK-12369] Add local holdouts support to Go SDK by @Mat001 in https://github.com/optimizely/go-sdk/pull/451
* [FSSDK-12670] Block ODP identify events with single identifier by @jaeopt in https://github.com/optimizely/go-sdk/pull/452
* [FSSDK-12760] Add localHoldouts to datafile for backward compatibility by @jaeopt in https://github.com/optimizely/go-sdk/pull/453
* [FSSDK-12813] Normalize decision event campaign_id, variation_id, and entity_id by @jaeopt in https://github.com/optimizely/go-sdk/pull/455
* [FSSDK-12750] Use attribute ID instead of key for CMAB prediction requests by @raju-opti in https://github.com/optimizely/go-sdk/pull/456


**Full Changelog**: https://github.com/optimizely/go-sdk/compare/v2.4.0...v2.5.0
...
**Full Changelog**: https://github.com/optimizely/go-sdk/compare/v2.3.1...v2.4.0
