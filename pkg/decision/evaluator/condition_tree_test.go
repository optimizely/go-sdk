...
func (s *ConditionTreeTestSuite) TestConditionTreeEvaluateSimpleCondition() {
	...
	result, _, _ := s.conditionTreeEvaluator.Evaluate(conditionTree, condTreeParams, &s.options)
	s.True(result)
...
func (s *ConditionTreeTestSuite) TestConditionTreeEvaluateAnAudienceTreeMultipleAudiences() {
	...
	result, _, _ := s.conditionTreeEvaluator.Evaluate(audienceTree, treeParams, &s.options)
	s.True(result)
