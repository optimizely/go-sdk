...
// FeatureNotificationWithVariablesForDecide constructs feature notification with variables
func FeatureNotificationWithVariablesForDecide(featureKey string, tracked bool, featureDecision *FeatureDecision, userContext *entities.UserContext,
	variables map[string]interface{}) *notification.DecisionNotification {

	decisionNotification := FeatureNotificationForDecide(featureKey, tracked, featureDecision, userContext)
...
// FeatureNotificationForDecide constructs default feature notification
func FeatureNotificationForDecide(featureKey string, tracked bool, featureDecision *FeatureDecision, userContext *entities.UserContext) *notification.DecisionNotification {
	sourceInfo := map[string]interface{}{}

	if featureDecision.Source == FeatureTest {
		sourceInfo["experimentKey"] = featureDecision.Experiment.Key
		sourceInfo["variationKey"] = featureDecision.Variation.Key
		sourceInfo["tracked"] = tracked
	}
