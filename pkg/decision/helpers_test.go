...
func (m *MockAudienceTreeEvaluator) Evaluate(node *entities.TreeNode, condTreeParams *entities.TreeParameters, options []decide.Options, reasons decide.DecisionReasons) (evalResult, isValid bool) {
