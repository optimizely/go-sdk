...
import (
	...
	optimizely "github.com/optimizely/go-sdk/pkg"
...
func NewStaticProjectConfigManager(config config.ProjectConfig) *StaticProjectConfigManager {
...
func (cm *StaticProjectConfigManager) GetConfig() (config.ProjectConfig, error) {
	cm.configLock.Lock()
