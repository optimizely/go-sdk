	...
	expectedRolloutMap := map[string]entities.Rollout{
		"21111": entities.Rollout{
			...
			Experiments: []entities.Experiment{
				entities.Experiment{ID: "11111", Key: "exp_11111", VariationsIDMap: map[string]entities.Variation{}, VariationsKeyMap: map[string]entities.Variation{}, TrafficAllocation: []entities.Range{}},
				entities.Experiment{ID: "11112", Key: "exp_11112", VariationsIDMap: map[string]entities.Variation{}, VariationsKeyMap: map[string]entities.Variation{}, TrafficAllocation: []entities.Range{}},
			},
		},
	}
